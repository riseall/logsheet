                    ...
                    @forelse($logsheet->details as $index => $det)
                        <tr class="hover:bg-slate-50/60 transition">
                            ...
                            <td class="px-6 py-4">
                                ...
                                @else
                                    <span class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-semibold bg-[#FEE2E2] text-[#991B1B] border border-rose-200">
            ...
            <div class="flex items-start space-x-3">
                ...
                <div>
                    <p class="text-sm font-semibold text-[#1E3A5F]">
                        Disubmit oleh Teknisi: <span class="text-emerald-700 font-bold">{{ $logsheet->teknisi->name ?? '-' }}</span>
                    </p>
            ...
            @foreach($logsheet->approvalLogs as $log)
                <div class="flex items-start space-x-3">
                    ...
                    <div>
                        ...
                        @if($log->note)
                            <div class="mt-1 text-xs text-slate-600 bg-slate-50 p-2.5 rounded-lg border border-slate-100 max-w-lg">
