        ...
        <div class="w-full max-w-md">
            ...
            <div class="bg-white rounded-3xl shadow-xl shadow-slate-200/50 border border-slate-100 overflow-hidden">
                ...
                <form action="{{ route('login.post') }}" method="POST" class="px-6 sm:px-10 pt-6 pb-8 space-y-5">
                    ...
                    <!-- Submit Button -->
                    <x-button type="submit" variant="teal" size="lg" class="w-full shadow-lg shadow-emerald-600/25 group">
                        <span>Masuk ke Dashboard</span>
                        <svg class="w-4 h-4 transform group-hover:translate-x-1 transition ms-2" fill="none"
